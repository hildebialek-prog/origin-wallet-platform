    ...
    <div className="bg-[#f8f8f6] px-4 py-8 sm:px-7 sm:py-10 dark:bg-[#161a20]">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Button
            variant="outline"
            className="w-full rounded-full border-[#7ae3cb] bg-white px-6 text-[1rem] font-semibold text-[#232323] hover:bg-[#f3fdf9] sm:w-auto dark:border-white/15 dark:bg-[#252b34] dark:text-white dark:hover:bg-[#2d3440]"
          >
            Statements
          </Button>
        </div>
        ...
        <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:flex-wrap lg:items-center">
          <select className="h-11 w-full rounded-lg border border-[#202020] bg-white px-4 text-[1rem] text-[#202020] sm:w-auto dark:border-white/15 dark:bg-[#1b2027] dark:text-white">
            <option>HKD</option>
            <option>EUR</option>
            <option>USD</option>
          </select>
          <select className="h-11 w-full rounded-lg border border-[#202020] bg-white px-4 text-[1rem] text-[#6b6b6b] sm:min-w-[18.5rem] sm:w-auto dark:border-white/15 dark:bg-[#1b2027] dark:text-gray-300">
          ...
          <button className="inline-flex w-full items-center justify-center gap-2 text-[1rem] font-semibold text-[#3d3d3d] sm:w-auto lg:ml-auto dark:text-gray-300">
        ...
        <Card className="overflow-hidden rounded-2xl border border-[#d7d7d2] bg-white shadow-none dark:border-white/10 dark:bg-[#1b2027]">
          ...
          {TRANSACTIONS.length === 0 && (
            <div className="border-t border-[#ecece7] px-5 py-3 text-center text-xs text-[#8a8a8a] sm:hidden dark:border-white/5 dark:text-gray-500">
              Swipe horizontally to review table columns on smaller screens.
            </div>
          )}
        </Card>
