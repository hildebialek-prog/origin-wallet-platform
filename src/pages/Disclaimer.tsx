...
const sections: LegalSection[] = [
  ...
  { title: "Service Availability", paragraphs: ["Origin Wallet provides a platform experience and integrates with Nium as a third-party financial and payment platform/provider. Financial or payment functions may be delivered or supported by Nium or other relevant third parties under their applicable terms. Products, currencies, corridors, payment methods, integrations, and features shown on the website may not be available to every user or in every location. Availability may depend on eligibility, verification, provider coverage, operational capacity, applicable requirements, and risk controls."] },
