            ...
            {[
              {
                ...
                desc: "Set up account access and onboarding entry points from one business experience.",
              },
              {
                step: "02",
        ...
        <div className="container-wide mx-auto grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          ...
          <motion.div {...fadeUp} className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              {
                title: "SaaS",
                desc: "Platform experiences that need API integrations and finance workflows.",
              },
            ].map((segment) => (
              <div
                key={segment.title}
