...
import { Mail, Lock, Eye, EyeOff, Loader2, User, Phone, AlertCircle } from "lucide-react";
      ...
      >
        <Card className="border-0 shadow-2xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>
              Sign up with Google or create an account using email and password
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input className="pl-10" value={name} onChange={(e) => setName(e.target.value)} placeholder="John Doe" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input className="pl-10" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="name@example.com" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input className="pl-10" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+84 123 456 789" />
                </div>
              </div>
